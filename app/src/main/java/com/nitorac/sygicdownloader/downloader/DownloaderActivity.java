...
public class DownloaderActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadUri = Uri.parse(FILE13);
        destinationUri = Uri.parse(mapDirCountry + "dbp");
        final DownloadRequest downloadRequest13 = new DownloadRequest(downloadUri)
                .setRetryPolicy(retryPolicy)
                .setDestinationURI(destinationUri).setPriority(DownloadRequest.Priority.NORMAL)
                .setDownloadListener(myDownloadStatusListener);
        ...
        mCancelAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mProgress13Txt.setText("Erreur Normale | " + MainActivity.country_chosen + ".dbp" + " : " + errorCode + ", " + errorMessage);
                mProgress13.setProgress(0);
                mProgress13Txt.setTextColor(getResources().getColor(R.color.Error));
        ...
        mProgress13Txt.setText("En attente | " + MainActivity.country_chosen + ".dbp" + " : ...");
        ...
        alertDialogBuilder
                ...
                .setNegativeButton("Non", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        i.putExtra("maj_list", maj_list_down);
                        i.putExtra("continent", pass_continent);
                        i.putExtra("country", pass_country);
                        i.putExtra("country_code", pass_country_code);
                        i.putExtra("flag", pass_flag);
                        startActivity(i);
                        dialog.dismiss();
                    }
                });
    ...
    class MyDownloadStatusListener implements DownloadStatusListener {
        ...
        public void onDownloadComplete(int id) {
            if (id == downloadId1) {
                mProgress1Txt.setText(MainActivity.country_chosen + ".2dc" + " : Terminé !");
                mProgress1Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId2) {
                mProgress2Txt.setText(MainActivity.country_chosen + ".2dt" + " : Terminé !");
                mProgress2Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId3) {
                mProgress3Txt.setText(MainActivity.country_chosen + ".cam" + " : Terminé !");
                mProgress3Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId4) {
                mProgress4Txt.setText(MainActivity.country_chosen + ".hmp" + " : Terminé !");
                mProgress4Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId5) {
                mProgress5Txt.setText(MainActivity.country_chosen + ".lma" + " : Terminé !");
                mProgress5Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId6) {
                mProgress6Txt.setText(MainActivity.country_chosen + ".ne0" + " : Terminé !");
                mProgress6Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId7) {
                mProgress7Txt.setText(MainActivity.country_chosen + ".ne1" + " : Terminé !");
                mProgress7Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId8) {
                mProgress8Txt.setText(MainActivity.country_chosen + ".ne2" + " : Terminé !");
                mProgress8Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId9) {
                mProgress9Txt.setText(MainActivity.country_chosen + ".nhs" + " : Terminé !");
                mProgress9Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId10) {
                mProgress10Txt.setText(MainActivity.country_chosen + ".pak" + " : Terminé !");
                mProgress10Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId11) {
                mProgress11Txt.setText(MainActivity.country_chosen + ".pnm" + " : Terminé !");
                mProgress11Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId12) {
                mProgress12Txt.setText(MainActivity.country_chosen + ".poi" + " : Terminé !");
                mProgress12Txt.setTextColor(getResources().getColor(R.color.Finished));
            } else if (id == downloadId13) {
                mProgress13Txt.setText(MainActivity.country_chosen + ".dbp" + " : Terminé !");
                mProgress13Txt.setTextColor(getResources().getColor(R.color.Finished));
        ...
        public void onDownloadFailed(int id, int errorCode, String errorMessage) {
            if (id == downloadId1) {
                ...
                mProgress13Txt.setText("Erreur Normale | " + MainActivity.country_chosen + ".dbp");
                mProgress13.setProgress(0);
                mProgress13Txt.setTextColor(getResources().getColor(R.color.Error));
        ...
        public void onProgress(int id, long totalBytes, long downloadedBytes, int progress) {
            if (id == downloadId1) {
                ...
                mProgress13Txt.setText(MainActivity.country_chosen + ".dbp" + " : " + progress + " % " + "  " + getBytesDownloaded(progress, totalBytes));
                mProgress13.setProgress(progress);
            }
        }
